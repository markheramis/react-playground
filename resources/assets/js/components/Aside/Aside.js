          ...
          <TabPane tabId="1">
            ...
            <div className="callout callout-warning m-0 py-3">
              <div className="avatar float-right">
                <img
                  src={"http://localhost:8000/public/img/avatars/7.jpg"}
            ...
            <div className="callout callout-info m-0 py-3">
              <div className="avatar float-right">
                <img
                  src={"http://localhost:8000/public/img/avatars/4.jpg"}
                  className="img-avatar"
                  alt="admin@bootstrapmaster.com"
                />
              </div>
            ...
            <div className="callout callout-danger m-0 py-3">
              ...
              <div className="avatars-stack mt-2">
                <div className="avatar avatar-xs">
                  <img
                    src={"http://localhost:8000/public/img/avatars/2.jpg"}
                    className="img-avatar"
                    alt="admin@bootstrapmaster.com"
                  />
                </div>
                <div className="avatar avatar-xs">
                  <img
                    src={"http://localhost:8000/public/img/avatars/3.jpg"}
                    className="img-avatar"
                    alt="admin@bootstrapmaster.com"
                  />
                </div>
                ...
                <div className="avatar avatar-xs">
                  <img
                    src={"http://localhost:8000/public/img/avatars/5.jpg"}
                    className="img-avatar"
                    alt="admin@bootstrapmaster.com"
                  />
                </div>
            ...
            <div className="callout callout-primary m-0 py-3">
              ...
              <div className="avatars-stack mt-2">
                ...
                <div className="avatar avatar-xs">
                  <img
                    src={"http://localhost:8000/public/img/avatars/8.jpg"}
                    className="img-avatar"
                    alt="admin@bootstrapmaster.com"
                  />
                </div>

          ...
          <main className="main">
            ...
            <Container fluid>
              <Switch>
                ...
                <Route path="/ads/create" name="CreateAds" component={CreateAds} />
                <Route path="/ads/edit" name="EditAds" component={EditAds} />
                <Route path="/ads/list" name="ListAds" component={ListAds} />

                <Route path="/campaign/create" name="CreateCampaigns" component={CreateCampaigns} />
                <Route path="/campaign/edit" name="EditCampaign" component={EditCampaigns} />
                <Route path="/campaign/list" name="ListCampaign" component={ListCampaigns} />

                <Route path="/tours/create" name="CreateTours" component={CreateTours} />
                <Route path="/tours/edit" name="EditTours" component={EditTours} />
                <Route path="/tours/list" name="ListTours" component={ListTours} />
